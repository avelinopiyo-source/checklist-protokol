...
export default async function handler(req, res) {
  ...
  try {
    ...
    // ID de tu carpeta asignada directamente en el código
    const CARPETA_DRIVE_ID = "1d0rTRiT7eSh0cmtIFXLbbmqyRuhxbRCm"; 

    // 1. Conexión segura con Google Drive (Usa tus variables de cuenta de servicio de Vercel)
    ...
    // 2. Construir el documento PDF en limpio
    ...
    // 3. Subir el archivo PDF final directamente a tu carpeta de Google Drive
